...
#最终返回的blobs为一个字典：
#“data”：图像数据 (N,W,H,C)
#"gt_boxes": 真实框的位置(此时已经进行了尺度缩放) （N,4）
#"gt_ishard":
#"dontcare_areas"
#"im_info":[N,3],(width,height,scale),注意此处的width和heigth都是相对于原始图像进行了缩放操作后的scale记录的就是缩放比例
#"im_name":
...
for step in range(start_step, end_step+1):
    ...
    print("training data:",im_data.shape)
    print("img_name:",blobs['im_name'])
    print("dontcare_areas:",dontcare_areas)
